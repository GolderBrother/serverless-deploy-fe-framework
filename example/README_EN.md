...
Easily deploy website-starter applications to Tencent Cloud's serverless infrastructure using this Serverless Cloud Framework Component.
...
```bash
scf init website-starter --name example
cd example
```
